							...
							<div class="row profile-account">
								<div class="col-md-3">
									<ul class="ver-inline-menu tabbable margin-bottom-10">
										...
										?>
										<li class="<?php echo ($karyawan->num_rows()==0) ? 'active' : ''?>">
											<a data-toggle="tab" href="#tab_3-3">
											<i class="fa fa-lock"></i> Change Password </a>
										</li>
										<li class="">
											<a href="<?php echo base_url('manual');?>" target="_blank">
											<i class="fa fa-search"></i> Manual </a>
										</li>
									</ul>
								</div>
								<div class="col-md-9">
									<div class="tab-content">
										...
										if($karyawan->num_rows()>0){
											...
											<div id="tab_1-1" class="tab-pane active">
												<div class="form-group">
													...
													<input type="text" class="form-control" value="<?php echo $kar['perusahaan_nama']?>" disabled/>
												</div>
												<div class="form-group keduanya">
													<label class="control-label"><?php if($kar['perusahaan_id']==1){ echo 'NIP Karyawan'; }elseif($kar['perusahaan_id']==2){ echo 'No Reg Satpam'; }?></label>
													<input type="text" class="form-control" value="<?php echo $kar['karyawan_nip']?>" disabled/>
												</div>
												<div class="form-group pjb">
													<label class="control-label">Jabatan</label>
													<input type="text" placeholder="Jabatan" class="form-control" value="<?php echo $kar['jabatan_nama']?>" disabled/>
												</div>
												<div class="form-group keduanya">
													<label class="control-label">Tanggal Masuk</label>
													<input type="text" placeholder="Tanggal Masuk" class="form-control" value="<?php echo ($kar['karyawan_tanggal_masuk']!='') ? date('d F Y', strtotime($kar['karyawan_tanggal_masuk'])) : '';?>" disabled/>
												</div>
												<div class="form-group pjb">
													<label class="control-label">District</label>
													<input type="text" placeholder="District" class="form-control" value="<?php echo $kar['district_nama']?>" disabled/>
												</div>
												<div class="form-group pjb">
													<label class="control-label">Bidang</label>
													<input type="text" placeholder="Bidang" class="form-control" value="<?php echo $kar['bidang_nama']?>" disabled/>
												</div>
												<div class="form-group">
													<label class="control-label">Nama Karyawan</label>
													<input type="text" placeholder="John" class="form-control" value="<?php echo $kar['karyawan_nama']?>" disabled/>
												</div>
												<div class="form-group">
													<label class="control-label">No Telepon</label>
													<input type="text" placeholder="No Telepon" id="karyawan_tlp" class="form-control" value="<?php echo $kar['karyawan_tlp']?>"/>
												</div>
												<div class="form-group pjb">
													<label class="control-label">Email</label>
													<input type="text" placeholder="Email" class="form-control" id="karyawan_email" value="<?php echo $kar['karyawan_email']?>"/>
												</div>
												
												<div class="form-group">
													<label class="control-label">Alamat</label>
													<textarea class="form-control" rows="3" placeholder="Alamat" id="karyawan_alamat"><?php echo $kar['karyawan_alamat']?></textarea>
												</div>
										...
										?>
										<div id="tab_3-3" class="tab-pane <?php echo ($karyawan->num_rows()==0) ? 'active' : ''?>">
												<div class="form-group">
...
perusahaan_id = <?php echo json_encode($kar['perusahaan_id'])?>;

if(perusahaan_id==1){
	$('.pjb').removeAttr('style');
	$('.keduanya').removeAttr('style');
	$('.satpam').attr('style', 'display:none');
}else if(perusahaan_id==2){
	$('.satpam').removeAttr('style');
	$('.keduanya').removeAttr('style');
	$('.pjb').attr('style', 'display:none');
}
