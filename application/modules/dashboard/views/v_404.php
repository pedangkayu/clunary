...
<div class="page-inner">
	<img src="<?php echo base_url();?>assets/admin/pages/img/earth.jpg" class="img-responsive" alt="">
</div>
<div class="container error-404">
	<h1>404</h1>
	<h2>Halaman yang Anda minta tidak ditemukan.</h2>
	<p>
	...
	<p>
		...
		if($kode_role==5){
			echo '
				<a href="'.site_url('dashboard').'">Return home </a>
			';
		}elseif($kode_role==1){
			echo '
				<a href="'.site_url('order/0').'">Return home </a>
			';
		}elseif($kode_role==2){
			echo '
				<a href="'.site_url('kasir').'">Return home </a>
			';
		}
		?>
		<br>
