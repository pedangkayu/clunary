		...
		<div id="cont">
				...
				<div class="www">
					...
					<div class="tr" >
						<div style="border-top:1px solid #999; margin-top:10px; text-align:right;color:#000;">
							Total Penjualan Gundala :  <?php echo 'Rp'.number_format($total_fonte, 0, ',', '.'); ?>
						</div>
						<div style="margin-top:10px; text-align:right;color:#000;">
							Total Diskon Gundala :  <?php echo 'Rp'.number_format($total_diskon_fonte, 0, ',', '.'); ?>
						</div>
						<div style="margin-top:10px; text-align:right;color:#000;">
							Pendapatan Bersih Gundala :  <?php echo 'Rp'.number_format($total_fonte-$total_diskon_fonte, 0, ',', '.'); ?>
						</div> 
					</div>
				</div>
			</div>
			...
			<div class="suteki isine fon">
				<div class="www">
					...
					<div class="tr" >
						<div style="border-top:1px solid #999; margin-top:10px; text-align:right;color:#000;">
							Total Penjualan Tenant :  <?php echo 'Rp'.number_format($total_suteki, 0, ',', '.'); ?>
						</div>
						<div style="margin-top:10px; text-align:right;color:#000;">
							Total Diskon Tenant :  <?php echo 'Rp'.number_format($total_diskon_suteki, 0, ',', '.'); ?>
						</div>
						<div style="margin-top:10px; text-align:right;color:#000;">
							Pendapatan Bersih Tenant :  <?php echo 'Rp'.number_format($total_suteki-$total_diskon_suteki, 0, ',', '.'); ?>
						</div> 
					</div>
				</div>
			</div>
		...
		<div id="top">
			...
			<div id="tit">
				...
				<div class="tr">
					...
					<div class="isi"><?php echo 'Rp '.number_format($total_penjualan, 0, ',', '.');?></div>
				</div>
				<div class="tr">
					<div class="label"> Total Service </div>:
					<div class="isi"><?php echo 'Rp '.number_format($total_service, 0, ',', '.');?></div>
				</div>
				<div class="tr">
					<div class="label">Total Diskon</div>:
					<div class="isi"><?php echo 'Rp '.number_format($total_diskon_suteki+$total_diskon_fonte, 2, ',', '.');?></div>
				</div>
			</div>
		</div>
