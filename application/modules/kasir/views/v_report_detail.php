	...
	<div class="_audit">
		...
		<div id="tit">
			...
			<div class="tr">
				...
				<div class="isi"><?php echo 'Rp '.number_format($dt->total_selisih, 0, ',', '.');?></div>
			</div>
		</div>
		<div id="cont">
			<div id="nav">
				<div class="nav_li" id="fon">Gundala</div>
				<div class="nav_li" id="sut">Tenant</div>
			</div>
			<div class="fonte isine fon">
				<div class="www">
					<div class="tr">
						<div class="trh" style="width:10%">Qty</div>
						<div class="trh" style="width:50%">Menu</div>
						<div class="trh" style="width:20%">Harga</div>
						<div class="trh" style="width:20%">Total</div>
					</div>
					<?php
					$total_fonte=0;
					$trc=0;
					...
					<div class="tr <?php echo $trs; ?>">
						<div class="tri" style="width:10%; text-align:center;color:#000;"><?php echo $r->jml_menu;?></div>
						<div class="tri" style="width:50%; text-align:left;color:#000;"><?php echo $r->nama_menu;?></div>
						<div class="tri" style="width:20%; text-align:right; color:#000;"><?php echo 'Rp'.number_format($r->harga,  0, ',', '.');?></div>
						<div class="tri" style="width:20%; text-align:right;color:#000;"><?php echo 'Rp'.number_format($r->total, 0, ',', '.');?></div>
					</div>
						<?php
					...
					<div class="tr" ><div style="border-top:1px solid #999; margin-top:10px; text-align:right;color:#000;">
						Total Penjualan Gundala :  <?php echo 'Rp'.number_format($total_fonte, 0, ',', '.'); ?></div> 
					</div>
				</div>
			</div>
			<div class="suteki isine sut">
				<div class="www">
					...
					<div class="tr <?php echo $trs; ?>">
						...
						<?php  endforeach ?>
					<div class="tr" ><div style="border-top:1px solid #999; margin-top:10px; text-align:right;color:#000;">
						Total Penjualan  :  <?php echo 'Rp'.number_format($total_fonte, 0, ',', '.'); ?></div> 
				  </div>
				</div>
			</div>
		<!-- 	<div class="suteki isine sut">
		...
		<div class="aa"><a href="<?php echo site_url().'kasir/c_transaksi/print_report/'.$tgl_submit; ?>" target="_top"> Print</a></div>
	</div>
</div>
...
.label {display: inline-block; width: 67%;}
.isi {display: inline-block; width: 30%; text-align: right; padding: 0 5px;}
