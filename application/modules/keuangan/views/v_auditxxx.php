		...
		<div class="col-md-12">
			...
			<div class="portlet box blue-hoki">
				<div class="portlet-title">
					<div class="caption">
						<i class="fa fa-briefcase"></i>Data Audit
					</div>
...
$('#unduh_audit').click(function (e) { 
	...
	if(filter_jenis=='' || $('input[name="from"]').val()=='' || $('input[name="to"]').val()==''){
		...
		location.replace("<?php echo site_url(); ?>/keuangan/c_audit/export?jenis_laporan="+filter_jenis+"&tgl_mulai="+tgl_mulai+"&tgl_sampai="+tgl_sampai);
	}	 
});
