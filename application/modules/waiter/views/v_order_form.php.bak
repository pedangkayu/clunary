	...
	<div class="portlet-body form">
		<div class="form-body">
			<div class="row">
				...
				<div class="col-md-6">
					<div class="form-group">
						<label class="control-label">Nomor Meja <font color="orange">*</font></label>
						<select class="form-control input-xlarge" id="kode_meja" disabled>
							...
							foreach ($meja->result() as $r) {
								...
								echo '<option value="'.$r->kode_meja.'" '.$terpilih.'>'.$r->kode_meja.'</option>';
							}
							?>
						</select>
					</div>
			...
			<div class="row">
				...
				<br>
				<div id="total_bayar">Total : Rp 0</div>
				<div id="service_fee">Service (%) : Rp 0</div>
